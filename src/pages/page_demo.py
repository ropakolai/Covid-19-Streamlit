...
def page_demo(title):
    ...
    test_img_path=os.path.join(paths['main_path'],paths['data_folder'],paths["test_images_path"])
    ...
    liste_modeles_3c = {"ResNet50":"resnet50_3classes.keras",
    ...
    if st.button('Exécuter'):
            ...
            if model_name != "":
                ...
                for image in image_class_dic.keys():
                    ...
                    if image != "Temps d'exécution":
                        ...
                        # 2. Génération du Gradcam et renvoi du chemin de l'image gradcam -- UNIQUEMENT POUR VGG
                        if "vgg" in modele.lower():
        ...
        if model_tabs != []:
            ...
            for i,modele in enumerate(model_tabs):
                model_name = model_dict[modele]
                print(f"model tabs modele_name {model_name}")
                if model_name !="":
